...
import LogoImgMainNav from '../public/assets/NC-Logo-Main-Bg.jpg'
import LogoImgSideNav from '../public/assets/NC-Logo-Side-Bg.jpg'
...
{/* Div that holds holds top navbar content  */}
            <div className='flex justify-between items-center w-full h-full pr-6 2=xl:px-16'>
                    ...
                    <Image src={LogoImgMainNav} width='120' height='120' alt='Logo' className='z-0' priority/>
                <div>
{/* Top Navbar Links */}
...
{/* Top of side navbar */}
                        <div className='flex w-full items-center justify-between'> 
                         <Image className='z-0' src={LogoImgSideNav} width='130' height='130' alt='/' /> 
{/* Close Button */}
