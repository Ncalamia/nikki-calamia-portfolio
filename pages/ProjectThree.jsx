...
{/* Div that holds Title */}
        <div className='absolute top-[85%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
          <h2 className='py-2'>America's Gun Problem</h2>
        </div>
      </div>
...
{/* Div that holds buttons(code,site) */}
          <div className='flex flex-row justify-center mt-4 items-baseline'>
            <a className='bg-[#495f4b] shadow-lg shadow-gray-500 rounded-xl hover:bg-[#e2a185] mx-3 xs:mt-5 xs:mx-8' href='https://github.com/mahamamoor/frontendapp'
              target='_blank'>
              <button className='text-white px-5 py-2 xs:p-3 xs:px-8'>Code</button>
            </a>
            <a className='bg-[#495f4b] shadow-lg shadow-gray-500 rounded-xl hover:bg-[#e2a185] mx-3 xs:mt-5 xs:mx-8' href='https://americas-gun-problem.herokuapp.com/'
              target='_blank'>
